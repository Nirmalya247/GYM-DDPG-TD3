...
def createActor():
    ...
    # hidden layer
    hiddenLayer = layers.Dense(34, activation="relu")(inputLayer)
    hiddenLayer = layers.Dense(68, activation="relu")(hiddenLayer)
    hiddenLayer = layers.Dense(34, activation="relu")(hiddenLayer)
    # output layer
...
def createCritic():
    ...
    stateHiddenLayer = layers.Dense(34, activation="relu")(stateInputLayer)
    stateHiddenLayer = layers.Dense(68, activation="relu")(stateHiddenLayer)
    stateHiddenLayer = layers.Dense(34, activation="relu")(stateHiddenLayer)
    # action
    actionInputLayer = layers.Input(shape=(actionSpace))
    actionHiddenLayer = layers.Dense(12, activation="relu")(actionInputLayer)
    actionHiddenLayer = layers.Dense(24, activation="relu")(actionHiddenLayer)
    actionHiddenLayer = layers.Dense(12, activation="relu")(actionHiddenLayer)
    # hidden layer
    concat = layers.Concatenate()([stateHiddenLayer, actionHiddenLayer])

    hiddenLayer = layers.Dense(92, activation="relu")(concat)
    hiddenLayer = layers.Dense(46, activation="relu")(hiddenLayer)
