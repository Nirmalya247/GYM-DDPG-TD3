...
def createActor():
    ...
    # hidden layer
    hiddenLayer = layers.Dense(400, activation="relu")(inputLayer)
    hiddenLayer = layers.Dense(300, activation="relu")(hiddenLayer)
    hiddenLayer = layers.Dense(300, activation="relu")(hiddenLayer)
    # output layer
...
def createCritic():
    ...
    stateHiddenLayer = layers.Dense(200, activation="relu")(stateInputLayer)
    stateHiddenLayer = layers.Dense(300, activation="relu")(stateHiddenLayer)
    # action
    actionInputLayer = layers.Input(shape=(actionSpace))
    actionHiddenLayer = layers.Dense(16, activation="relu")(actionInputLayer)
    actionHiddenLayer = layers.Dense(32, activation="relu")(actionHiddenLayer)
    # hidden layer
    concat = layers.Concatenate()([stateHiddenLayer, actionHiddenLayer])

    hiddenLayer = layers.Dense(400, activation="relu")(concat)
    hiddenLayer = layers.Dense(400, activation="relu")(hiddenLayer)
    hiddenLayer = layers.Dense(300, activation="relu")(hiddenLayer)
